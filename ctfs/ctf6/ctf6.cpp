...
int main(int argc, char **argv)
{
    ...
    // de-obfuscation
    deobfuscate5(distraction01_ob, BUFSIZE, distraction01, &distraction_len);
    ...
    #endif
    deobfuscate5(distraction02_ob, BUFSIZE, distraction02, &distraction_len);
    #ifdef DEBUG_PASSWORD
    printf("p0mp0m: %s\n", (char*)distraction02);
    #endif
    deobfuscate5(distraction03_ob, BUFSIZE, distraction03, &distraction_len);
    #ifdef DEBUG_PASSWORD
    ...
    printf("%s\n", (char*)flag);
    #endif
    deobfuscate5(distraction04_ob, BUFSIZE, distraction04, &distraction_len);
    #ifdef DEBUG_PASSWORD
    printf("%%cellar_door%%: %s\n", (char*)distraction04);
    #endif
    deobfuscate5(distraction05_ob, BUFSIZE, distraction05, &distraction_len);
    #ifdef DEBUG_PASSWORD
    printf("!whimsical1: %s\n", (char*)distraction05);
    #endif
